<template>
    <div id="PostPage"
        ...
        <div class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <video v-if="true" class="absolute object-cover w-full my-auto z-[-1] h-screen" src="/cat.mp4" />
            ...
            <div class="bg-black bg-opacity-70 lg:min-w-[480px]">
                <video v-if="true" ref="video" loop muted class="h-screen mx-auto" src="/cat.mp4" />
            </div>
        ...
        <div id="InfoSection" v-if="true" class="lg:max-w-[550px] relative w-full h-full bg-white">
            ...
            <div id="Comments" class="bg-[#F8F8F8] z-0 w-full h-[calc(100%-273px)] border-t-2 overflow-auto">
                ...
                <div v-if="true" class="text-center mt-6 text-xl text-gray-500">
                    No comments...
                </div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            <div class="text-[18px] font-semibold flex items-center justify-between">
                                User Name
                                <Icon v-if="true" class="cursor-pointer" name="material-symbols:delete-outline-sharp"
                                    size="25" />
                            </div>
