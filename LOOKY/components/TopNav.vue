<template>
    <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b h-[61px] mx-auto">
                ...
                <div v-else class="flex items-center">
                    ...
                    <div class="relative">
                        <button class="mt-1" @click="showMenu = !showMenu">
                            <img class="rounded-full" width="33" src="https://picsum.photos/id/83/300/300">
                        </button>
